        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-bold text-xl text-white">
                Pet<span className="text-primary-400">Connect</span>
              </span>
            </Link>
            <p className="text-sm text-neutral-400">
              A community-driven platform helping people care for street animals,
              report lost/found pets, and connect with shelters.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/care-points" className="text-sm hover:text-primary-400 transition-colors">
                  Care Points
                </Link>
              </li>
              <li>
                <Link to="/lost-found" className="text-sm hover:text-primary-400 transition-colors">
                  Lost & Found
                </Link>
              </li>
              <li>
                <Link to="/shelters" className="text-sm hover:text-primary-400 transition-colors">
                  Shelters
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm">
                ...
                <a href="mailto:hello@petconnect.com" className="hover:text-primary-400 transition-colors">
